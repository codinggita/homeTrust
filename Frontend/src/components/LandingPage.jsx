...
const TESTIMONIALS = [
  {
    ...
    quote: "HomeTrust's reports caught a neighborhood noise issue we would have missed. Saved us from a regret move.",
    stars: 5,
  },
  {
    name: "Marcus Jones",
    role: "First-time renter",
    quote: "The verification badges actually mean something. I felt safe signing my lease without the usual scam anxiety.",
    stars: 5,
  },
  {
    name: "David Lee",
    role: "Institutional analyst",
    quote: "Genuinely institutional-grade data – comparable to what we pay six figures for at the fund.",
    stars: 5,
  },
];
